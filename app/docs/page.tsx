...
import { ArrowLeft, BookOpen, Terminal, Cpu, Database } from "lucide-react";
    ...
    <div className="bg-linear-to-br from-zinc-950 to-black min-h-screen text-zinc-100 p-4 sm:p-8 md:p-12 overflow-x-hidden">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div 
          ...
          className="bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-[2rem] p-6 sm:p-8 md:p-12 shadow-2xl relative overflow-hidden"
        >
          ...
          <div className="space-y-10 md:space-y-12 mt-8 md:mt-10">
            ...
            <section className="w-full">
              ...
              {/* Added w-full, overflow-x-auto, and whitespace-pre-wrap to fix mobile overflow */}
              <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-4 md:p-5 w-full overflow-x-auto shadow-inner">
                <pre className="text-xs md:text-sm text-zinc-300 font-mono leading-loose whitespace-pre-wrap break-all font-[family-name:var(--font-jetbrains-mono)]">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-zinc-950/50 border border-zinc-800 rounded-xl p-4 md:p-5">
                  <h3 className="text-indigo-400 font-bold mb-2 font-[family-name:var(--font-jetbrains-mono)] text-sm md:text-base">loading State</h3>
                ...
                <div className="bg-zinc-950/50 border border-zinc-800 rounded-xl p-4 md:p-5">
                  <h3 className="text-indigo-400 font-bold mb-2 font-[family-name:var(--font-jetbrains-mono)] text-sm md:text-base">repository State</h3>
