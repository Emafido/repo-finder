...
import { ArrowLeft, BookOpen, Code, Terminal, Cpu, Database } from "lucide-react";
import { motion } from "framer-motion";

export default function Documentation() {
  return (
    <div className="bg-linear-to-br from-zinc-950 to-black min-h-screen text-zinc-100 font-sans p-6 md:p-12 overflow-x-hidden">
      <div className="max-w-4xl mx-auto">
        
        <Link href="/" className="inline-flex items-center gap-2 text-zinc-400 hover:text-indigo-400 transition-colors mb-8 font-medium">
          <ArrowLeft size={18} />
          Return to Dashboard
        </Link>
        ...
        <motion.div 
          ...
          className="bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden"
        >
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="bg-indigo-500/10 p-3.5 rounded-2xl border border-indigo-500/20 shadow-inner">
              <BookOpen className="text-indigo-400" size={32} />
            </div>
            <div>
              <h1 className="text-3xl md:text-5xl font-black tracking-tighter text-white">System Architecture</h1>
              <p className="text-zinc-400 mt-2 font-medium tracking-wide">RepoFinder Technical Documentation v1.0</p>
            </div>
          </div>
          ...
          <div className="space-y-12 mt-10">
            {/* Section 1: Overview */}
            <section>
              <h2 className="flex items-center gap-3 text-2xl font-bold text-zinc-100 mb-5 pb-3 border-b border-zinc-800/80">
            ...
            <section>
              ...
              <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-5 overflow-x-auto shadow-inner">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-zinc-950/50 border border-zinc-800 rounded-xl p-5">
                  <h3 className="text-indigo-400 font-bold mb-2">loading State</h3>
                  <p className="text-sm text-zinc-400">A boolean trigger that disables the main execution button and mounts a pulsing Framer Motion skeleton loader.</p>
                </div>
                <div className="bg-zinc-950/50 border border-zinc-800 rounded-xl p-5">
                  <h3 className="text-indigo-400 font-bold mb-2">repository State</h3>
                  <p className="text-sm text-zinc-400">A typed object storing the exact payload required for the UI (name, description, stargazers, forks, issues, url).</p>
                </div>
              </div>
            </section>
